...
class AdminDashboardController extends Controller
{
    public function index()
    {
        ...
        $recentTenders = \App\Modules\Procurement\Domain\Models\PurchaseRequisition::whereIn('status', ['awarded', 'ordered'])
        ...
        if ($topStats->isNotEmpty()) {
            $items = \App\Modules\Catalogue\Domain\Models\CatalogueItem::with(['category', 'primaryImage'])
