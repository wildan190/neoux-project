                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <span class="px-2 py-0.5 bg-primary-100 text-primary-700 text-[8px] font-black uppercase tracking-widest rounded-md">ACTION REQUIRED</span>
                            </div>
                            ...
                            <div class="bg-primary-50 dark:bg-primary-900/20 px-4 py-3 rounded-xl border border-primary-100 dark:border-primary-800/30">
                                <p class="text-[8px] font-black text-primary-600 dark:text-primary-400 uppercase tracking-widest mb-1">Buyer's Counter Offer</p>
                                <p class="text-xs text-primary-900 dark:text-primary-100">{{ $offer->negotiation_message ?? 'Check offer details for requested terms.' }}</p>
                            </div>
                        </div>

                        <div class="flex flex-col lg:items-end gap-3 rounded-2xl min-w-[200px]">
                            <div class="text-right">
                                <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Proposed Amount</p>
