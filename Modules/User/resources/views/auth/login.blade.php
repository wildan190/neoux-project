...
<div class="min-h-screen flex">
    ...
    <div class="w-full lg:w-[60%] flex items-center justify-center p-8 md:p-12 lg:p-20 bg-white dark:bg-gray-900 overflow-y-auto">
        <div class="w-full max-w-lg">
            ...
            <div class="lg:hidden text-center mb-10">
                <div class="w-16 h-16 bg-primary-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-8">
                ...
                <div class="space-y-6">
                    <div class="group">
                        <label for="email" class="block text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-4">Email Address</label>
                        <div class="relative">
    ...
    <div class="hidden lg:flex w-[40%] bg-gray-900 relative overflow-hidden">
        ...
        <div class="relative z-10 w-full flex flex-col justify-between p-20">
            <div class="w-16 h-16 bg-primary-600 rounded-2xl flex items-center justify-center shadow-xl">
                <i data-feather="box" class="w-8 h-8 text-white"></i>
            </div>

            <div class="max-w-md">
                <p class="text-primary-500 text-[10px] font-bold uppercase tracking-[0.3em] mb-4">Join the Network</p>
                <h2 class="text-4xl font-bold text-white uppercase tracking-tight leading-none mb-8">
                    Smart <br> 
                    <span class="text-white/60 font-medium italic">Sourcing</span> <br>
                    Redefined
                </h2>
            ...
            <div class="flex gap-12">
                <div>
                    <p class="text-3xl font-bold text-white leading-none">12k+</p>
                    <p class="text-[9px] font-bold text-gray-500 uppercase tracking-widest mt-3">Verified Vendors</p>
                </div>
                <div>
                    <p class="text-3xl font-bold text-white leading-none">Global</p>
                    <p class="text-[9px] font-bold text-gray-500 uppercase tracking-widest mt-3">Accessibility</p>
                </div>
            </div>
        </div>
