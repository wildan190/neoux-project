    ...
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-primary-500 to-secondary-500 rounded-2xl p-8 text-white shadow-xl">
            <div class="flex items-center gap-6">
                ...
                <div>
                    <h1 class="text-3xl font-bold mb-2">Register New Company</h1>
                    <p class="text-white/80">Daftarkan perusahaan Anda untuk mulai menggunakan platform procurement NeoUX</p>
                </div>
            </div>
        </div>
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/30 border-b border-gray-100 dark:border-gray-700">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Nama dan tipe perusahaan Anda</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                <span class="inline-flex items-center gap-1">
                                    ...
                                    Format: JPG, PNG, GIF. Maksimal 2MB. Direkomendasikan 400x400px
                                </span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Nama resmi sesuai akta pendirian</p>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="category" id="category" 
                                ...
                                <option value="buyer" {{ old('category') == 'buyer' ? 'selected' : '' }}>🛒 Buyer (Pembeli)</option>
                                <option value="supplier" {{ old('category') == 'supplier' ? 'selected' : '' }}>📦 Supplier (Pemasok)</option>
                                <option value="vendor" {{ old('category') == 'vendor' ? 'selected' : '' }}>🏪 Vendor (Penjual)</option>
                            </select>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Pilih sesuai peran utama di platform</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="business_category" id="business_category" value="{{ old('business_category') }}"
                                class="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-3 shadow-sm focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 dark:bg-gray-700 dark:text-white transition" 
                                placeholder="e.g. Konstruksi, Teknologi, F&B" required>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Bidang industri utama perusahaan</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Nomor Pokok Wajib Pajak (15 digit)</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700">
                        <div class="flex justify-between items-center mb-3">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">Tambahkan lokasi cabang atau warehouse jika ada</p>
                            </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" 
                            class="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-3 shadow-sm focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 dark:bg-gray-700 dark:text-white transition resize-none"
                            placeholder="Jelaskan secara singkat tentang perusahaan Anda, produk/layanan yang ditawarkan, dan keunggulan kompetitif...">{{ old('description') }}</textarea>
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Maksimal 500 karakter</p>
                    </div>

                    {{-- Document Upload --}}
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Dokumen Perusahaan</label>
                        <div id="drop-zone" class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-primary-400 hover:bg-primary-50/50 dark:hover:bg-primary-900/10 transition-all cursor-pointer bg-gray-50 dark:bg-gray-700/30">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">SIUP, TDP, NIB, Akta Pendirian (PDF, JPG, PNG - Max 2MB)</p>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-sm text-gray-700 dark:text-gray-300 font-medium">Dengan mendaftar, Anda menyetujui</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400">Syarat & Ketentuan serta Kebijakan Privasi NeoUX</p>
                        </div>
                    </div>
                    <div class="flex gap-3">
                        <a href="{{ route('companies.index') }}" class="px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            Batal
                        </a>
