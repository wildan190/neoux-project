    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                {{ $view === 'vendor' ? 'Sales Returns' : 'Goods Return Requests' }}
            </h1>
            <p class="text-gray-500 dark:text-gray-400 mt-1">
                {{ $view === 'vendor' ? 'Kelola pengembalian barang dari pelanggan' : 'Kelola laporan barang rusak atau tidak sesuai' }}
            </p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 mb-6">
        <div class="border-b border-gray-200 dark:border-gray-700">
            <nav class="flex -mb-px overflow-x-auto">
                <a href="{{ route('procurement.grr.index', ['filter' => 'all', 'view' => $view]) }}"
                ...
                <a href="{{ route('procurement.grr.index', ['filter' => 'pending', 'view' => $view]) }}"
                ...
                <a href="{{ route('procurement.grr.index', ['filter' => 'in_progress', 'view' => $view]) }}"
                ...
                <a href="{{ route('procurement.grr.index', ['filter' => 'resolved', 'view' => $view]) }}"
