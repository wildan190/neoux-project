@extends('layouts.app', [
    'title' => 'Print PO: ' . $purchaseOrder->po_number,
])
...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-4 no-print">
            ...
            <a href="{{ route('procurement.po.download-pdf', $purchaseOrder) }}" class="px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-bold shadow-sm ml-2 inline-block">
        ...
        <div id="printable-content" class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-primary-500 to-secondary-500 px-8 py-6 text-white">
                <div class="flex justify-between items-start">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-lg font-mono">{{ $purchaseOrder->po_number }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-8 py-4 bg-gray-50 grid grid-cols-4 gap-4 text-sm border-b border-gray-200">
                <div>
                    ...
                    <p class="text-gray-900 font-bold">{{ $purchaseOrder->created_at->format('d M Y') }}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-gray-900 font-bold uppercase">{{ $purchaseOrder->status }}</p>
                </div>
                <div>
                    <p class="text-gray-500 font-semibold">Created By</p>
                    <p class="text-gray-900 font-bold">{{ $purchaseOrder->createdBy->name }}</p>
                </div>
            </div>
                        ...
                        <div class="h-16 flex items-end justify-center mb-2">
                            <div class="text-center">
                                ...
                                <p class="font-mono text-sm text-gray-500 border border-gray-300 px-3 py-1 rounded bg-gray-50">
                                    {{ md5($purchaseOrder->purchaseRequisition->user->email . $purchaseOrder->created_at) }}
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="text-center">
                        <div class="h-16 flex items-end justify-center mb-2">
                            <div class="text-center">
                                <p class="text-xs text-gray-400 italic mb-1">Digital Signature</p>
                                <p class="font-mono text-sm text-gray-500 border border-gray-300 px-3 py-1 rounded bg-gray-50">
                                    {{ md5($purchaseOrder->vendorCompany->user->email . $purchaseOrder->created_at) }}
                                </p>
                            </div>
                        </div>
                        <div class="border-t-2 border-gray-400 pt-2">
