...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-1">List of price adjustments for rejected or damaged goods</p>
        </div>
    </div>
    ...
    @if($debitNotes->isEmpty())
        <div
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">No Debit Notes Found</h3>
            <p class="text-gray-500 dark:text-gray-400">Debit notes will appear after a price adjustment resolution is selected
                in a GRR.</p>
        </div>
    @else
        <div
