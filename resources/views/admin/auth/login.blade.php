...
<body class="bg-gradient-to-br from-primary-500 to-purple-600 min-h-screen flex items-center justify-center p-6">
        ...
        <form method="POST" action="{{ route('admin.login') }}">
            ...
            <div class="mb-4">
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus
                    class="w-full rounded-lg border border-gray-300 px-4 py-3 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>
