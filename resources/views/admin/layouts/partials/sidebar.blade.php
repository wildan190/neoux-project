<aside class="w-64 bg-white dark:bg-gray-800 shadow-md flex-shrink-0">
    ...
    <nav class="mt-6">
        <a href="{{ route('admin.dashboard') }}"
            class="flex items-center px-6 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.dashboard') ? 'bg-gray-100 dark:bg-gray-700 border-r-4 border-indigo-500' : '' }}">
            <i data-feather="home" class="w-5 h-5 mr-3"></i>
            <span>Dashboard</span>
        </a>

        <a href="{{ route('admin.companies.index') }}"
            class="flex items-center px-6 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.companies.*') ? 'bg-gray-100 dark:bg-gray-700 border-r-4 border-indigo-500' : '' }}">
            <i data-feather="briefcase" class="w-5 h-5 mr-3"></i>
            <span>Companies</span>
        </a>

        <a href="{{ route('admin.users.index') }}"
            class="flex items-center px-6 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.users.*') ? 'bg-gray-100 dark:bg-gray-700 border-r-4 border-indigo-500' : '' }}">
