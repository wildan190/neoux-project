...
<body
    ...
    <div
        class="flex flex-col md:flex-row bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden max-w-4xl w-full">
        {{-- Left side: Illustration --}}
    <div class="hidden md:flex md:w-1/2 bg-primary-500 dark:bg-primary-600 items-center justify-center relative flex-col">
        <div class="mb-8">
            <img src="{{ asset('assets/img/logo.png') }}" alt="Logo" class="h-20 bg-white rounded-2xl p-2 shadow-lg">
        </div>
